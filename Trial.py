...
#WHERE I STAND: I can buy properties, show ownership and charge rent, show correct properties and test if they are for sale or not.
#NEXT: End the Game - I THINK THIS IS IN WORKING ORDER - DOUBLE CHECK
#build chance and community chest
#build doubles function
#do not allow players to collect rent while they are out of the game
